...
static var descs = [
	...
	"Tutorial step 2/4: Reveal the iota contained in the entity in the next room. [url=P2srLlL]Scout's[/url] can be used to get the entity, and [url=P2Lllllls]Chronicler's[/url] to read it's iota. Remember to see Hexbook for other needed patterns.",
	...
	"Tutorial step 4/4: Finish on the green area by teleporting through the glass using [url=P2sssLllsrrrrrsll]Teleport[/url].",
]
