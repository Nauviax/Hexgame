...
static var descs = [
	...
	"Tutorial step 3/4: Move the entity onto the red area past the spikes. [url=P5lllllLssLsLsR]Blue Sun's[/url] and [url=P4LslllsLls]Impulse[/url] should be used. Number/Vector patterns are in the Hexbook.",
